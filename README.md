...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,601 | 🐛 5 | 📅 2026-09-21
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,601 | 🐛 5 | 📅 2026-09-21
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,601 | 🐛 5 | 📅 2026-09-21 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,738 | 🐛 1,930 | 🌐 Go | 📅 2026-09-25
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,381 | 🐛 0 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,006 | 🐛 10 | 🌐 HCL | 📅 2026-09-25 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 964 | 🐛 13 | 🌐 HCL | 📅 2026-09-25 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
...
* [terraform-aws-ec2-instance](https://github.com/terraform-aws-modules/terraform-aws-ec2-instance) ⭐ 811 | 🐛 2 | 🌐 HCL | 📅 2026-09-25 - Creates EC2 instances on AWS.
...
* [terraform-aws-alb](https://github.com/terraform-aws-modules/terraform-aws-alb) ⭐ 465 | 🐛 2 | 🌐 HCL | 📅 2026-08-26 - Creates Application load-balancer on AWS (verified module).
...
* [terralist](https://github.com/terralist/terralist) ⭐ 521 | 🐛 10 | 🌐 Go | 📅 2026-09-25 - Terraform Private Registry for modules and providers manageable from a REST API.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,102 | 🐛 3,584 | 🌐 Go | 📅 2026-09-25 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,971 | 🐛 3,033 | 🌐 Go | 📅 2026-09-25 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,651 | 🐛 2,910 | 🌐 Go | 📅 2026-09-25 - Provider for Google Cloud Platform.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,182 | 🐛 343 | 🌐 Go | 📅 2026-09-24 - Provider for GitHub.
...
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 949 | 🐛 343 | 🌐 Go | 📅 2026-09-25 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
...
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 889 | 🌐 Go | 📅 2026-09-25 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 470 | 🐛 418 | 🌐 Go | 📅 2026-09-25 - Provider for Datadog.
...
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 88 | 🌐 Go | 📅 2026-09-25 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 138 | 🌐 Go | 📅 2026-09-25 - Provider for Confluent.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 4 | 🌐 Go | 📅 2026-09-24 - Terraform provider for Coolify.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 4 | 🌐 Go | 📅 2026-09-24 - Terraform provider for Coolify.
...
* [terraform-provider-seerr](https://github.com/Josh-Archer/terraform-provider-seerr) ⭐ 5 | 🐛 7 | 🌐 Go | 📅 2026-09-24 - Terraform provider for Seerr (Overseerr/Jellyseerr).
* [terraform-provider-plancost](https://github.com/plancost/terraform-provider-plancost) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-03-11 - Terraform provider for Azure cost estimation and cost guardrails.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,953 | 🐛 7 | 🌐 Go | 📅 2026-09-25 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,738 | 🐛 1,930 | 🌐 Go | 📅 2026-09-25 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,536 | 🐛 21 | 🌐 Go | 📅 2026-09-25 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,854 | 🐛 220 | 🌐 Go | 📅 2026-09-25 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,301 | 🐛 924 | 🌐 Go | 📅 2026-09-24 - Unified workflow for collaborating on Terraform through GitHub.
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,822 | 🐛 32 | 🌐 Go | 📅 2026-09-24 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,778 | 🐛 30 | 🌐 Shell | 📅 2026-09-25 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
...
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,329 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,707 | 🐛 319 | 🌐 Open Policy Agent | 📅 2026-09-24 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [blast radius](https://github.com/28mm/blast-radius) ⭐ 2,192 | 🐛 47 | 🌐 JavaScript | 📅 2024-08-14 - Interactive visualizations of Terraform dependency graphs. :skull:
* [inframap](https://github.com/cycloidio/inframap) ⭐ 2,068 | 🐛 50 | 🌐 Go | 📅 2026-04-23 - Read your tfstate or HCL to generate a graph specific for each provider, showing only the resources that are most important/relevant.
...
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,914 | 🐛 25 | 🌐 Go | 📅 2026-09-25 - A tool to bring existing Azure resources under Terraform's management.
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,640 | 🐛 4 | 🌐 Python | 📅 2026-09-25 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,383 | 🐛 292 | 🌐 Go | 📅 2026-09-25 - A universal tool that converts deep merged YAML to module inputs.
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,294 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - A textual user interface for Terraform state.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 549 | 🐛 29 | 🌐 Go | 📅 2026-09-25 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 404 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-25 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 208 | 🐛 20 | 🌐 Go | 📅 2026-09-25 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 161 | 🐛 4 | 🌐 Go | 📅 2026-09-25 - Rename Terraform resources and generate moved blocks
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2026-09-25 - CLI to prevent malicious Terraform Providers from being executed
...
* [drifthound](https://github.com/drifthoundhq/drifthound) ⭐ 71 | 🐛 22 | 🌐 Ruby | 📅 2026-04-23 - Continuous infrastructure drift detection with historical tracking and notifications.
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 45 | 🐛 11 | 🌐 Shell | 📅 2026-09-25 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-25 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,576 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-25
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 754 | 🐛 59 | 🌐 Go | 📅 2026-09-25 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,203 | 🐛 262 | 🌐 Go | 📅 2026-09-25 (Terraform Language Server)
