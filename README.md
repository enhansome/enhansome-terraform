...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,592 | 🐛 5 | 📅 2026-09-09
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,592 | 🐛 5 | 📅 2026-09-09
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,592 | 🐛 5 | 📅 2026-09-09 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,650 | 🐛 1,919 | 🌐 Go | 📅 2026-09-12
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,340 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,533 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) ⭐ 3,262 | 🐛 17 | 🌐 HCL | 📅 2026-08-28 - Creates VPC resources on AWS (verified and very popular module).
...
* [typhoon](https://github.com/poseidon/typhoon) ⭐ 2,053 | 🐛 6 | 🌐 HCL | 📅 2026-08-31 - Minimal and free Kubernetes distribution with Terraform.
...
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 963 | 🐛 19 | 🌐 HCL | 📅 2026-09-08 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
...
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 585 | 🐛 7 | 🌐 HCL | 📅 2026-08-26 - Creates S3 bucket resources on AWS.
...
* [terraform-cloudflare-maintenance](https://github.com/adinhodovic/terraform-cloudflare-maintenance) ⭐ 128 | 🐛 1 | 🌐 HCL | 📅 2026-09-13 - Module to create a Maintenance Page using Cloudflare Workers.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 520 | 🐛 20 | 🌐 Go | 📅 2026-09-12 - Terraform Private Registry for modules and providers manageable from a REST API.
* [Terrareg](https://github.com/matthewjohn/terrareg) ⭐ 347 | 🐛 20 | 🌐 Go | 📅 2026-05-11 - Terraform module registry.
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 293 | 🐛 28 | 🌐 Go | 📅 2026-09-11 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,088 | 🐛 3,599 | 🌐 Go | 📅 2026-09-12 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,970 | 🐛 3,073 | 🌐 Go | 📅 2026-09-12 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,645 | 🐛 2,712 | 🌐 Go | 📅 2026-09-13 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,719 | 🐛 216 | 🌐 Go | 📅 2026-09-11 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,076 | 🐛 196 | 🌐 Go | 📅 2026-09-02 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 116 | 🌐 Go | 📅 2026-09-11 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,180 | 🐛 332 | 🌐 Go | 📅 2026-09-11 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 946 | 🐛 340 | 🌐 Go | 📅 2026-09-11 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 738 | 🐛 58 | 🌐 Go | 📅 2026-09-11 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 698 | 🐛 215 | 🌐 Go | 📅 2026-09-11 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 829 | 🌐 Go | 📅 2026-09-11 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 568 | 🐛 193 | 🌐 Go | 📅 2026-09-09 - Provider for DigitalOcean.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 468 | 🐛 411 | 🌐 Go | 📅 2026-09-11 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 436 | 🐛 111 | 📅 2026-08-20 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 430 | 🐛 211 | 🌐 Go | 📅 2026-09-09 - Provider for Azure DevOps (VSTS).
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 805 | 🌐 Go | 📅 2026-09-11 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 294 | 🐛 184 | 🌐 Go | 📅 2026-09-11 - Provider for Rancher v2.
...
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 70 | 🌐 Go | 📅 2026-09-13 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-heroku](https://github.com/heroku/terraform-provider-heroku) ⭐ 102 | 🐛 36 | 🌐 Go | 📅 2026-09-11 - Provider for Heroku.
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 73 | 🐛 23 | 🌐 Go | 📅 2026-09-11 - Provider to manage UCloud resources.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 139 | 🌐 Go | 📅 2026-09-13 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 18 | 🌐 Go | 📅 2026-09-11 - Provider for Buildkite.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 9 | 🌐 Go | 📅 2026-09-08 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 39 | 🐛 12 | 🌐 Go | 📅 2026-09-03 - Provider for [env0](https://www.env0.com/)
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 29 | 🐛 8 | 🌐 Go | 📅 2026-09-10 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-phare](https://github.com/phare/terraform-provider-phare) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-09-12 -  Terraform provider for [Phare](https://phare.io).
* [terraform-provider-devhelm](https://github.com/devhelmhq/terraform-provider-devhelm) ⭐ 0 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Provider for [DevHelm](https://devhelm.io) uptime monitoring — manage monitors, alert channels, and status pages as code.
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,954 | 🐛 128 | 🌐 Go | 📅 2026-09-02 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 819 | 🐛 36 | 🌐 Go | 📅 2026-09-11 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 342 | 🐛 9 | 🌐 Go | 📅 2026-09-11 - Terraform provider for managing MinIO S3 buckets and IAM Users.
* [terraform-provider-terracurl](https://github.com/devops-rob/terraform-provider-terracurl) ⭐ 164 | 🐛 13 | 🌐 Go | 📅 2026-08-17 - Provider to make managed and unmanaged API calls to your target endpoint.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 24 | 🐛 5 | 🌐 Go | 📅 2026-09-12 - Terraform provider for Coolify.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 24 | 🐛 5 | 🌐 Go | 📅 2026-09-12 - Terraform provider for Coolify.
...
* [terraform-provider-seerr](https://github.com/Josh-Archer/terraform-provider-seerr) ⭐ 5 | 🐛 7 | 🌐 Go | 📅 2026-09-13 - Terraform provider for Seerr (Overseerr/Jellyseerr).
* [terraform-provider-plancost](https://github.com/plancost/terraform-provider-plancost) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-03-11 - Terraform provider for Azure cost estimation and cost guardrails.
...
* [terraform-provider-paddle](https://github.com/vivantel/terraform-provider-paddle) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-09-12 - Terraform provider for Paddle Billing catalog resources, lifecycle actions, and lookup data sources.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,944 | 🐛 5 | 🌐 Go | 📅 2026-09-13 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,650 | 🐛 1,919 | 🌐 Go | 📅 2026-09-12 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,517 | 🐛 22 | 🌐 Go | 📅 2026-09-09 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,831 | 🐛 231 | 🌐 Go | 📅 2026-09-13 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,287 | 🐛 935 | 🌐 Go | 📅 2026-09-13 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,999 | 🐛 169 | 🌐 Python | 📅 2026-09-10 - Terraform static analysis tool for terraform>=0.12
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,812 | 🐛 30 | 🌐 Go | 📅 2026-09-12 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,821 | 🐛 194 | 🌐 Go | 📅 2026-09-02 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,772 | 🐛 26 | 🌐 Shell | 📅 2026-09-11 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,629 | 🐛 102 | 🌐 Go | 📅 2026-09-08 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,327 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-09-11 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
* [driftctl](https://github.com/snyk/driftctl) ⭐ 2,665 | 🐛 156 | 🌐 Go | 📅 2026-08-27 - Detect, track, and alert on infrastructure drift :skull:
...
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,390 | 🐛 95 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [Kapitan](https://github.com/kapicorp/kapitan) ⭐ 1,926 | 🐛 155 | 🌐 Python | 📅 2026-09-09 - Generates Terraform/OpenTofu JSON and other infrastructure configuration from inventory-driven templates.
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,912 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - A tool to bring existing Azure resources under Terraform's management.
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,631 | 🐛 5 | 🌐 Python | 📅 2026-09-04 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
...
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,400 | 🐛 19 | 🌐 Go | 📅 2026-09-11 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,376 | 🐛 299 | 🌐 Go | 📅 2026-09-13 - A universal tool that converts deep merged YAML to module inputs.
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - A textual user interface for Terraform state.
* [tfmigrate](https://github.com/minamijoyo/tfmigrate) ⭐ 1,277 | 🐛 23 | 🌐 Go | 📅 2026-05-04 - A Terraform state migration tool for GitOps.
...
* [terratag](https://github.com/env0/terratag) ⭐ 1,055 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - Terratag is a CLI tool that enables users of Terraform to automatically create and maintain tags across their entire set of AWS, Azure, and GCP resources.
...
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 929 | 🐛 5 | 🌐 HCL | 📅 2026-09-11 - Pike calculates the permissions or IAM policy required to build your Terraform.
* [tfautomv](https://github.com/busser/tfautomv) ⭐ 900 | 🐛 18 | 🌐 Go | 📅 2026-09-02 - Generate Terraform `moved` blocks automatically for painless refactoring
...
* [AirIAM](https://github.com/bridgecrewio/AirIAM) ⭐ 826 | 🐛 34 | 🌐 Python | 📅 2025-03-18 - AirIAM is a tool for AWS IAM to least privilege Terraform execution framework.
* [iam-policy-json-to-terraform](https://github.com/flosell/iam-policy-json-to-terraform) ⭐ 817 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-10 - Small tool to convert an IAM Policy in JSON format into a Terraform aws\_iam\_policy\_document
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 548 | 🐛 29 | 🌐 Go | 📅 2026-09-13 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 463 | 🐛 17 | 🌐 Go | 📅 2026-09-13 - Documenting your Threat Models with HCL
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 400 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-13 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 371 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 - A CLI tool that helps you interact with Terraform via the Model Context Protocol (MCP), allowing AI assistants like Claude to manage and operate Terraform environments.
...
* [fogg](https://github.com/chanzuckerberg/fogg) ⭐ 306 | 🐛 1 | 🌐 Go | 📅 2026-09-09 - A tool for eliminating toil in managing terraform repositories.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,584 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 201 | 🐛 20 | 🌐 Go | 📅 2026-09-12 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
* [redc](https://github.com/wgpsec/redc) ⭐ 191 | 🐛 1 | 🌐 Go | 📅 2026-08-10 - Next-generation red team infrastructure automation tool built on Terraform, supporting multi-cloud deployment (Alibaba Cloud, Tencent Cloud, AWS, etc.) with one-command deployment for creating, configuring, and destroying red team environments.
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-09-13 - Rename Terraform resources and generate moved blocks
...
* [ruby-terraform](https://github.com/infrablocks/ruby_terraform) ⭐ 112 | 🐛 4 | 🌐 Ruby | 📅 2026-09-08 - Simple Ruby wrapper for invoking terraform commands.
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2026-09-13 - CLI to prevent malicious Terraform Providers from being executed
...
* [cloud-audit](https://github.com/gebalamariusz/cloud-audit) ⭐ 72 | 🐛 6 | 🌐 Python | 📅 2026-09-08 - AWS security auditing CLI with remediation engine that generates Terraform code for fixing misconfigurations.
...
* [renovate-config](https://github.com/SpotOnInc/renovate-config) ⭐ 55 | 🐛 3 | 📅 2026-09-08 - Sharable Config Presets for Renovatebot, especially useful for DevOps folks.
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 42 | 🐛 5 | 🌐 Shell | 📅 2026-09-13 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 19 | 🐛 2 | 🌐 Go | 📅 2026-09-11 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
...
* [tfmodcache](https://github.com/Rezarys/tfmodcache) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Local, shared module cache for Terraform and OpenTofu; `terraform init` stops re-downloading modules it already has. I am the author.
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-13 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-09-13.
...
* [setup-terraform](https://github.com/hashicorp/setup-terraform) ⭐ 1,585 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-07 - Sets up Terraform CLI in your GitHub Actions workflow.
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-10 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [opentofu-updater-action](https://github.com/drumandbytes/opentofu-updater-action) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - GitHub Action that keeps OpenTofu/Terraform providers, modules, Helm charts and container images up to date by opening pull requests.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,499 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-13
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 753 | 🐛 67 | 🌐 Go | 📅 2026-09-13 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
* [OTF](https://github.com/leg100/otf) ⭐ 703 | 🐛 28 | 🌐 Go | 📅 2026-07-16 - Open Terraforming Framework, an open source alternative to Terraform Enterprise with full Terraform CLI integration.
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,202 | 🐛 265 | 🌐 Go | 📅 2026-09-08 (Terraform Language Server)
* [Vim-Terraform](https://github.com/hashivim/vim-terraform) ⭐ 1,108 | 🐛 5 | 🌐 Vim Script | 📅 2025-05-24
