...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,593 | 🐛 6 | 📅 2026-09-09
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,593 | 🐛 6 | 📅 2026-09-09
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,593 | 🐛 6 | 📅 2026-09-09 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,670 | 🐛 1,933 | 🌐 Go | 📅 2026-09-16
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,346 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,535 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [Self-host n8n on Google Cloud Run](https://github.com/datawranglerai/self-host-n8n-on-gcr) ⭐ 619 | 🐛 0 | 🌐 HCL | 📅 2026-05-13 - Terraform configuration and guide for deploying n8n workflow automation on Cloud Run with Cloud SQL, Secret Manager, and optional Queue Mode via Redis.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,005 | 🐛 14 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [typhoon](https://github.com/poseidon/typhoon) ⭐ 2,052 | 🐛 7 | 🌐 HCL | 📅 2026-09-16 - Minimal and free Kubernetes distribution with Terraform.
...
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 963 | 🐛 15 | 🌐 HCL | 📅 2026-09-15 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
...
* [terraform-aws-security-group](https://github.com/terraform-aws-modules/terraform-aws-security-group) ⭐ 594 | 🐛 2 | 🌐 HCL | 📅 2026-08-06 - Creates EC2-VPC security groups on AWS (verified module).
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 585 | 🐛 8 | 🌐 HCL | 📅 2026-09-15 - Creates S3 bucket resources on AWS.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 520 | 🐛 21 | 🌐 Go | 📅 2026-09-16 - Terraform Private Registry for modules and providers manageable from a REST API.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,091 | 🐛 3,580 | 🌐 Go | 📅 2026-09-16 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,971 | 🐛 3,066 | 🌐 Go | 📅 2026-09-16 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,644 | 🐛 2,719 | 🌐 Go | 📅 2026-09-16 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,719 | 🐛 217 | 🌐 Go | 📅 2026-09-16 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,076 | 🐛 196 | 🌐 Go | 📅 2026-09-02 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 119 | 🌐 Go | 📅 2026-09-14 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,182 | 🐛 339 | 🌐 Go | 📅 2026-09-16 - Provider for GitHub.
...
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 948 | 🐛 340 | 🌐 Go | 📅 2026-09-16 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 739 | 🐛 57 | 🌐 Go | 📅 2026-09-16 - Provider for Hetzner Cloud.
...
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 850 | 🌐 Go | 📅 2026-09-16 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 568 | 🐛 195 | 🌐 Go | 📅 2026-09-16 - Provider for DigitalOcean.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 468 | 🐛 414 | 🌐 Go | 📅 2026-09-16 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 436 | 🐛 111 | 📅 2026-08-20 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 430 | 🐛 214 | 🌐 Go | 📅 2026-09-09 - Provider for Azure DevOps (VSTS).
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 806 | 🌐 Go | 📅 2026-09-16 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 294 | 🐛 182 | 🌐 Go | 📅 2026-09-11 - Provider for Rancher v2.
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 69 | 🌐 Go | 📅 2026-09-16 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 76 | 🌐 Go | 📅 2026-09-16 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 136 | 🌐 Go | 📅 2026-09-16 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 16 | 🌐 Go | 📅 2026-09-16 - Provider for Buildkite.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 9 | 🌐 Go | 📅 2026-09-16 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 39 | 🐛 14 | 🌐 Go | 📅 2026-09-16 - Provider for [env0](https://www.env0.com/)
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 30 | 🐛 10 | 🌐 Go | 📅 2026-09-16 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-qovery](https://github.com/Qovery/terraform-provider-qovery) ⭐ 18 | 🐛 10 | 🌐 Go | 📅 2026-09-16 - Provider for [Qovery](https://www.qovery.com/) — manage Kubernetes deployments, environments, applications, databases, Helm charts, and Terraform services on AWS, GCP, Azure, and Scaleway.
...
* [terraform-provider-nxip](https://github.com/uk-sw/terraform-provider-nxip) ⭐ 0 | 🐛 4 | 🌐 Go | 📅 2026-09-15 - Provider for [nxip](https://nx-ip.com), IPAM with pool-based CIDR allocation across cloud and on-premise. :heavy\_dollar\_sign:
...
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 819 | 🐛 39 | 🌐 Go | 📅 2026-09-15 - Terraform Docker provider.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 5 | 🌐 Go | 📅 2026-09-16 - Terraform provider for Coolify.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 5 | 🌐 Go | 📅 2026-09-16 - Terraform provider for Coolify.
...
* [terraform-provider-seerr](https://github.com/Josh-Archer/terraform-provider-seerr) ⭐ 5 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Terraform provider for Seerr (Overseerr/Jellyseerr).
* [terraform-provider-plancost](https://github.com/plancost/terraform-provider-plancost) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-03-11 - Terraform provider for Azure cost estimation and cost guardrails.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,942 | 🐛 10 | 🌐 Go | 📅 2026-09-16 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,670 | 🐛 1,933 | 🌐 Go | 📅 2026-09-16 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,518 | 🐛 22 | 🌐 Go | 📅 2026-09-09 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,833 | 🐛 250 | 🌐 Go | 📅 2026-09-16 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,291 | 🐛 940 | 🌐 Go | 📅 2026-09-13 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 9,004 | 🐛 171 | 🌐 Python | 📅 2026-09-16 - Terraform static analysis tool for terraform>=0.12
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,816 | 🐛 32 | 🌐 Go | 📅 2026-09-12 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,824 | 🐛 195 | 🌐 Go | 📅 2026-09-02 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,774 | 🐛 28 | 🌐 Shell | 📅 2026-09-16 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,629 | 🐛 103 | 🌐 Go | 📅 2026-09-08 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,324 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-16 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,912 | 🐛 24 | 🌐 Go | 📅 2026-09-15 - A tool to bring existing Azure resources under Terraform's management.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,436 | 🐛 46 | 🌐 Go | 📅 2026-09-01 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,401 | 🐛 22 | 🌐 Go | 📅 2026-09-11 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,378 | 🐛 286 | 🌐 Go | 📅 2026-09-16 - A universal tool that converts deep merged YAML to module inputs.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 548 | 🐛 28 | 🌐 Go | 📅 2026-09-16 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 401 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-16 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,592 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 202 | 🐛 19 | 🌐 Go | 📅 2026-09-16 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Rename Terraform resources and generate moved blocks
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - CLI to prevent malicious Terraform Providers from being executed
...
* [renovate-config](https://github.com/SpotOnInc/renovate-config) ⭐ 55 | 🐛 4 | 📅 2026-09-15 - Sharable Config Presets for Renovatebot, especially useful for DevOps folks.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 20 | 🐛 0 | 🌐 Go | 📅 2026-09-16 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
...
* [SyncVey](https://github.com/MR-TABATA/SyncVey) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - Self-hosted AWS asset ledger with attribute-level drift detection between tfstate and live AWS state, scheduled scans, and middleware EOL alerts.
...
* [setup-terraform](https://github.com/hashicorp/setup-terraform) ⭐ 1,587 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-07 - Sets up Terraform CLI in your GitHub Actions workflow.
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-16 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [tree-sitter-hcl](https://github.com/tree-sitter-grammars/tree-sitter-hcl) ⭐ 146 | 🐛 10 | 🌐 HCL | 📅 2026-09-13 - HCL grammar for tree-sitter
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,522 | 🐛 1,438 | 🌐 Rust | 📅 2026-09-16
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 752 | 🐛 65 | 🌐 Go | 📅 2026-09-16 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
...
* [Snap CD](https://github.com/schrieksoft/snapcd) ⭐ 9 | 🐛 1 | 🌐 C# | 📅 2026-09-16 - Fully-featured continuous deployment platform that facilitates modular deployments with isolated runners, dependency-aware automation, and fine-grained access control.
