...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,568 | 🐛 13 | 📅 2026-07-27
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,568 | 🐛 13 | 📅 2026-07-27
[![Not Found Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml) ⭐ 6,568 | 🐛 13 | 📅 2026-07-27
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,568 | 🐛 13 | 📅 2026-07-27 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,468 | 🐛 1,924 | 🌐 Go | 📅 2026-08-14
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,275 | 🐛 2 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,503 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 4,998 | 🐛 15 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
* [terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) ⭐ 3,255 | 🐛 18 | 🌐 HCL | 📅 2026-08-06 - Creates VPC resources on AWS (verified and very popular module).
...
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 582 | 🐛 8 | 🌐 HCL | 📅 2026-08-06 - Creates S3 bucket resources on AWS.
...
* [terraform-aws-efs](https://github.com/cloudposse/terraform-aws-efs) ⭐ 96 | 🐛 10 | 🌐 HCL | 📅 2026-08-15 - Defines an EFS Filesystem.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 512 | 🐛 22 | 🌐 Go | 📅 2026-08-16 - Terraform Private Registry for modules and providers manageable from a REST API.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,047 | 🐛 3,558 | 🌐 Go | 📅 2026-08-14 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,968 | 🐛 3,941 | 🌐 Go | 📅 2026-08-15 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,640 | 🐛 2,451 | 🌐 Go | 📅 2026-08-16 - Provider for Google Cloud Platform.
...
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 692 | 🐛 244 | 🌐 Go | 📅 2026-08-13 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 659 | 🐛 767 | 🌐 Go | 📅 2026-08-14 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 568 | 🐛 188 | 🌐 Go | 📅 2026-08-15 - Provider for DigitalOcean.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 465 | 🐛 425 | 🌐 Go | 📅 2026-08-15 - Provider for Datadog.
...
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 208 | 🐛 76 | 🌐 Go | 📅 2026-08-16 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 128 | 🌐 Go | 📅 2026-08-16 - Provider for Confluent.
...
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 39 | 🐛 13 | 🌐 Go | 📅 2026-08-16 - Provider for [env0](https://www.env0.com/)
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,938 | 🐛 123 | 🌐 Go | 📅 2026-08-14 - Terraform Proxmox provider.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 15 | 🐛 6 | 🌐 Go | 📅 2026-08-16 - Terraform provider for Coolify.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,468 | 🐛 1,924 | 🌐 Go | 📅 2026-08-14 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,455 | 🐛 24 | 🌐 Go | 📅 2026-08-11 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,779 | 🐛 227 | 🌐 Go | 📅 2026-08-16 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,236 | 🐛 890 | 🌐 Go | 📅 2026-08-16 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,941 | 🐛 161 | 🌐 Python | 📅 2026-08-13 - Terraform static analysis tool for terraform>=0.12
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,789 | 🐛 27 | 🌐 Go | 📅 2026-08-15 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,756 | 🐛 29 | 🌐 Shell | 📅 2026-08-15 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,622 | 🐛 103 | 🌐 Go | 📅 2026-07-31 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,317 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,686 | 🐛 326 | 🌐 Open Policy Agent | 📅 2026-08-14 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,384 | 🐛 94 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [Kapitan](https://github.com/kapicorp/kapitan) ⭐ 1,924 | 🐛 153 | 🌐 Python | 📅 2026-08-09 - Generates Terraform/OpenTofu JSON and other infrastructure configuration from inventory-driven templates.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,429 | 🐛 48 | 🌐 Go | 📅 2026-07-25 - OpenTofu/Terraform/Terragrunt version manager.
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,355 | 🐛 306 | 🌐 Go | 📅 2026-08-16 - A universal tool that converts deep merged YAML to module inputs.
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,290 | 🐛 12 | 🌐 Python | 📅 2024-07-09 - A textual user interface for Terraform state.
...
* [aws2tf](https://github.com/aws-samples/aws2tf) ⭐ 761 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - automates the importing of existing AWS resources into Terraform and outputs the Terraform HCL code.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 546 | 🐛 28 | 🌐 Go | 📅 2026-08-16 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 464 | 🐛 17 | 🌐 Go | 📅 2026-08-16 - Documenting your Threat Models with HCL
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 397 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-16 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 264 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,527 | 🐛 152 | 🌐 Go | 📅 2026-08-12 version manager
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-08-16 - Rename Terraform resources and generate moved blocks
...
* [sato](https://github.com/JamesWoolfenden/sato) ⭐ 109 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - Sato helps you convert your legacy Cloudformation into Terraform.
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 89 | 🐛 3 | 🌐 Go | 📅 2026-08-16 - CLI to prevent malicious Terraform Providers from being executed
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-07-18 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,271 | 🐛 1,417 | 🌐 Rust | 📅 2026-08-15
