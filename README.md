...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,583 | 🐛 10 | 📅 2026-08-25
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,583 | 🐛 10 | 📅 2026-08-25
[![Not Found Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml) ⭐ 6,583 | 🐛 10 | 📅 2026-08-25
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,583 | 🐛 10 | 📅 2026-08-25 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,592 | 🐛 1,921 | 🌐 Go | 📅 2026-08-31
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,318 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,001 | 🐛 16 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 291 | 🐛 28 | 🌐 Go | 📅 2026-08-31 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,048 | 🐛 3,545 | 🌐 Go | 📅 2026-08-31 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,972 | 🐛 3,138 | 🌐 Go | 📅 2026-08-31 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,642 | 🐛 2,645 | 🌐 Go | 📅 2026-08-31 - Provider for Google Cloud Platform.
...
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 121 | 🌐 Go | 📅 2026-08-31 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,163 | 🐛 342 | 🌐 Go | 📅 2026-08-27 - Provider for GitHub.
...
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 737 | 🐛 57 | 🌐 Go | 📅 2026-08-31 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 695 | 🐛 218 | 🌐 Go | 📅 2026-08-31 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 724 | 🌐 Go | 📅 2026-08-31 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 466 | 🐛 409 | 🌐 Go | 📅 2026-08-31 - Provider for Datadog.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 359 | 🐛 810 | 🌐 Go | 📅 2026-08-31 - Provider for IBM Cloud.
...
* [terraform-provider-artifactory](https://github.com/jfrog/terraform-provider-artifactory) ⭐ 289 | 🐛 87 | 🌐 Go | 📅 2026-08-31 - Provider for [JFrog Artifactory](https://jfrog.com/artifactory/).
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 66 | 🌐 Go | 📅 2026-08-31 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 208 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 73 | 🐛 25 | 🌐 Go | 📅 2026-08-31 - Provider to manage UCloud resources.
...
* [terraform-provider-coder](https://github.com/coder/terraform-provider-coder) ⭐ 60 | 🐛 47 | 🌐 Go | 📅 2026-08-31 - Provider for [Coder](https://coder.com)
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 135 | 🌐 Go | 📅 2026-08-31 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 13 | 🌐 Go | 📅 2026-08-31 - Provider for Buildkite.
...
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 29 | 🐛 12 | 🌐 Go | 📅 2026-08-31 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,947 | 🐛 124 | 🌐 Go | 📅 2026-08-30 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 818 | 🐛 36 | 🌐 Go | 📅 2026-08-31 - Terraform Docker provider.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,592 | 🐛 1,921 | 🌐 Go | 📅 2026-08-31 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,499 | 🐛 17 | 🌐 Go | 📅 2026-08-31 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,812 | 🐛 222 | 🌐 Go | 📅 2026-08-31 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,270 | 🐛 900 | 🌐 Go | 📅 2026-08-31 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,975 | 🐛 167 | 🌐 Python | 📅 2026-08-30 - Terraform static analysis tool for terraform>=0.12
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,799 | 🐛 30 | 🌐 Go | 📅 2026-08-29 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,620 | 🐛 104 | 🌐 Go | 📅 2026-08-31 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,321 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
...
* [inframap](https://github.com/cycloidio/inframap) ⭐ 2,061 | 🐛 50 | 🌐 Go | 📅 2026-04-23 - Read your tfstate or HCL to generate a graph specific for each provider, showing only the resources that are most important/relevant.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,430 | 🐛 46 | 🌐 Go | 📅 2026-08-31 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,397 | 🐛 18 | 🌐 Go | 📅 2026-07-28 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,364 | 🐛 297 | 🌐 Go | 📅 2026-08-31 - A universal tool that converts deep merged YAML to module inputs.
...
* [yor](https://github.com/bridgecrewio/yor) ⭐ 932 | 🐛 8 | 🌐 Go | 📅 2026-08-09 - Automatically tag and trace infrastructure as code frameworks (Terraform, Cloudformation, and Serverless).
...
* [tfautomv](https://github.com/busser/tfautomv) ⭐ 899 | 🐛 18 | 🌐 Go | 📅 2026-08-30 - Generate Terraform `moved` blocks automatically for painless refactoring
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 547 | 🐛 27 | 🌐 Go | 📅 2026-08-31 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 398 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-31 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [fogg](https://github.com/chanzuckerberg/fogg) ⭐ 306 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - A tool for eliminating toil in managing terraform repositories.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,558 | 🐛 151 | 🌐 Go | 📅 2026-08-28 version manager
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - Rename Terraform resources and generate moved blocks
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 89 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - CLI to prevent malicious Terraform Providers from being executed
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 40 | 🐛 2 | 🌐 Shell | 📅 2026-08-31 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [terrascope](https://github.com/spilliams/terrascope) ⭐ 26 | 🐛 43 | 🌐 Go | 📅 2026-08-31 - Build orchestrator for terraform monorepos.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-08-31.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-31 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,390 | 🐛 1,442 | 🌐 Rust | 📅 2026-08-31
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 751 | 🐛 73 | 🌐 Go | 📅 2026-08-31 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
