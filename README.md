...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,580 | 🐛 9 | 📅 2026-08-25
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,580 | 🐛 9 | 📅 2026-08-25
[![Not Found Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml) ⭐ 6,580 | 🐛 9 | 📅 2026-08-25
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,580 | 🐛 9 | 📅 2026-08-25 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,537 | 🐛 1,914 | 🌐 Go | 📅 2026-08-26
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,304 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Self-host n8n on Google Cloud Run](https://github.com/datawranglerai/self-host-n8n-on-gcr) ⭐ 614 | 🐛 0 | 🌐 HCL | 📅 2026-05-13 - Terraform configuration and guide for deploying n8n workflow automation on Cloud Run with Cloud SQL, Secret Manager, and optional Queue Mode via Redis.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 4,998 | 🐛 17 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 581 | 🐛 8 | 🌐 HCL | 📅 2026-08-26 - Creates S3 bucket resources on AWS.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 513 | 🐛 14 | 🌐 Go | 📅 2026-08-26 - Terraform Private Registry for modules and providers manageable from a REST API.
* [Terrareg](https://github.com/matthewjohn/terrareg) ⭐ 347 | 🐛 20 | 🌐 Go | 📅 2026-05-11 - Terraform module registry.
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 291 | 🐛 28 | 🌐 Go | 📅 2026-08-26 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
* [tapir](https://github.com/PacoVK/tapir) ⭐ 239 | 🐛 33 | 🌐 Java | 📅 2026-08-26 - Private Terraform Registry.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,047 | 🐛 3,578 | 🌐 Go | 📅 2026-08-26 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,974 | 🐛 3,948 | 🌐 Go | 📅 2026-08-26 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,642 | 🐛 2,596 | 🌐 Go | 📅 2026-08-26 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,720 | 🐛 206 | 🌐 Go | 📅 2026-08-24 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,077 | 🐛 196 | 🌐 Go | 📅 2026-07-10 - Provider for Helm.
...
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 945 | 🐛 341 | 🌐 Go | 📅 2026-08-24 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 736 | 🐛 59 | 🌐 Go | 📅 2026-08-25 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 693 | 🐛 241 | 🌐 Go | 📅 2026-08-26 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 663 | 🐛 805 | 🌐 Go | 📅 2026-08-26 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 465 | 🐛 407 | 🌐 Go | 📅 2026-08-26 - Provider for Datadog.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 360 | 🐛 809 | 🌐 Go | 📅 2026-08-25 - Provider for IBM Cloud.
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 67 | 🌐 Go | 📅 2026-08-26 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 208 | 🐛 67 | 🌐 Go | 📅 2026-08-26 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 128 | 🌐 Go | 📅 2026-08-25 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 12 | 🌐 Go | 📅 2026-08-26 - Provider for Buildkite.
...
* [terraform-provider-qovery](https://github.com/Qovery/terraform-provider-qovery) ⭐ 18 | 🐛 10 | 🌐 Go | 📅 2026-08-26 - Provider for [Qovery](https://www.qovery.com/) — manage Kubernetes deployments, environments, applications, databases, Helm charts, and Terraform services on AWS, GCP, Azure, and Scaleway.
...
* [terraform-provider-devhelm](https://github.com/devhelmhq/terraform-provider-devhelm) ⭐ 0 | 🐛 37 | 🌐 Go | 📅 2026-08-25 - Provider for [DevHelm](https://devhelm.io) uptime monitoring — manage monitors, alert channels, and status pages as code.

### Community providers

* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,946 | 🐛 125 | 🌐 Go | 📅 2026-08-25 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 817 | 🐛 37 | 🌐 Go | 📅 2026-08-25 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 341 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Terraform provider for managing MinIO S3 buckets and IAM Users.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,537 | 🐛 1,914 | 🌐 Go | 📅 2026-08-26 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,492 | 🐛 21 | 🌐 Go | 📅 2026-08-24 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,807 | 🐛 217 | 🌐 Go | 📅 2026-08-26 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,254 | 🐛 889 | 🌐 Go | 📅 2026-08-26 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,974 | 🐛 167 | 🌐 Python | 📅 2026-08-26 - Terraform static analysis tool for terraform>=0.12
* [tfsec](https://github.com/aquasecurity/tfsec) ⭐ 7,033 | 🐛 18 | 🌐 Go | 📅 2026-03-25 - Terraform static analysis tool that supports terraform <0.12 & >=0.12 & directly integrates with HCL parser for better results.
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,795 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,964 | 🐛 32 | 🌐 Shell | 📅 2026-07-01 - Terraform version manager inspired by rbenv.
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,814 | 🐛 191 | 🌐 Go | 📅 2026-08-03 - Quick utility to generate docs from terraform modules.
...
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,695 | 🐛 324 | 🌐 Open Policy Agent | 📅 2026-08-25 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
* [driftctl](https://github.com/snyk/driftctl) ⭐ 2,660 | 🐛 155 | 🌐 Go | 📅 2026-07-31 - Detect, track, and alert on infrastructure drift :skull:
...
* [inframap](https://github.com/cycloidio/inframap) ⭐ 2,058 | 🐛 49 | 🌐 Go | 📅 2026-04-23 - Read your tfstate or HCL to generate a graph specific for each provider, showing only the resources that are most important/relevant.
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,362 | 🐛 299 | 🌐 Go | 📅 2026-08-26 - A universal tool that converts deep merged YAML to module inputs.
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,290 | 🐛 11 | 🌐 Python | 📅 2024-07-09 - A textual user interface for Terraform state.
...
* [yor](https://github.com/bridgecrewio/yor) ⭐ 933 | 🐛 8 | 🌐 Go | 📅 2026-08-09 - Automatically tag and trace infrastructure as code frameworks (Terraform, Cloudformation, and Serverless).
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 927 | 🐛 6 | 🌐 HCL | 📅 2026-08-24 - Pike calculates the permissions or IAM policy required to build your Terraform.
...
* [terragrunt-atlantis-config](https://github.com/transcend-io/terragrunt-atlantis-config) ⭐ 745 | 🐛 91 | 🌐 HCL | 📅 2025-11-20 - Generate Atlantis config for Terragrunt projects.
...
* [tfupdate](https://github.com/minamijoyo/tfupdate) ⭐ 658 | 🐛 15 | 🌐 Go | 📅 2026-07-15 - Update version constraints in your Terraform configurations.
* [hcledit (minamijoyo)](https://github.com/minamijoyo/hcledit) ⭐ 554 | 🐛 20 | 🌐 Go | 📅 2026-05-05 - A command line editor for HCL.
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 547 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [terracost](https://github.com/cycloidio/terracost) ⭐ 357 | 🐛 21 | 🌐 Go | 📅 2026-05-07 - Cloud cost estimation for Terraform in your CLI.
...
* [terraform-aws-clickops-notifier](https://github.com/cloudandthings/terraform-aws-clickops-notifier) ⭐ 334 | 🐛 28 | 🌐 Python | 📅 2026-08-26 - Get notified when actions are taken in the AWS Console.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,547 | 🐛 152 | 🌐 Go | 📅 2026-08-12 version manager
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 89 | 🐛 5 | 🌐 Go | 📅 2026-08-26 - CLI to prevent malicious Terraform Providers from being executed
...
* [renovate-config](https://github.com/SpotOnInc/renovate-config) ⭐ 55 | 🐛 3 | 📅 2026-08-25 - Sharable Config Presets for Renovatebot, especially useful for DevOps folks.
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 39 | 🐛 18 | 🌐 Shell | 📅 2026-08-26 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [terrascope](https://github.com/spilliams/terrascope) ⭐ 26 | 🐛 44 | 🌐 Go | 📅 2026-08-25 - Build orchestrator for terraform monorepos.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-08-24 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-08-26.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,336 | 🐛 1,438 | 🌐 Rust | 📅 2026-08-26
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 750 | 🐛 75 | 🌐 Go | 📅 2026-08-26 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
