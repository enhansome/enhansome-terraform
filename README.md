...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,634 | 🐛 1,924 | 🌐 Go | 📅 2026-09-07
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,330 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,003 | 🐛 16 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [terraform-aws-ecs](https://github.com/terraform-aws-modules/terraform-aws-ecs) ⭐ 675 | 🐛 4 | 🌐 HCL | 📅 2026-08-09 - Creates AWS ECS resources on AWS.
...
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 584 | 🐛 8 | 🌐 HCL | 📅 2026-08-26 - Creates S3 bucket resources on AWS.
* [terraform-aws-atlantis](https://github.com/terraform-aws-modules/terraform-aws-atlantis) ⭐ 558 | 🐛 0 | 🌐 HCL | 📅 2026-08-26 - Creates Terraform configurations for running [Atlantis](https://runatlantis.io) on AWS Fargate. Github, Gitlab, and BitBucket are supported.
...
* [terraform-helm-carbon-intensity-exporter](https://github.com/fabiocicerchia/terraform-helm-carbon-intensity-exporter) ⭐ 0 | 🐛 1 | 🌐 HCL | 📅 2026-09-07 - Terraform/Helm module to deploy the Kubernetes Carbon Intensity Exporter.
* [terraform-helm-kepler](https://github.com/fabiocicerchia/terraform-helm-kepler) ⭐ 0 | 🐛 0 | 🌐 HCL | 📅 2026-09-07 - Terraform module to deploy Kepler (Kubernetes power profiling) via Helm.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,075 | 🐛 3,586 | 🌐 Go | 📅 2026-09-07 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,971 | 🐛 3,053 | 🌐 Go | 📅 2026-09-07 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,643 | 🐛 2,687 | 🌐 Go | 📅 2026-09-07 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,720 | 🐛 212 | 🌐 Go | 📅 2026-09-02 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,076 | 🐛 196 | 🌐 Go | 📅 2026-09-02 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 118 | 🌐 Go | 📅 2026-09-07 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,172 | 🐛 342 | 🌐 Go | 📅 2026-09-07 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 946 | 🐛 344 | 🌐 Go | 📅 2026-09-07 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
...
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 698 | 🐛 220 | 🌐 Go | 📅 2026-09-07 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 767 | 🌐 Go | 📅 2026-09-07 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 467 | 🐛 416 | 🌐 Go | 📅 2026-09-07 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 436 | 🐛 111 | 📅 2026-08-20 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 430 | 🐛 214 | 🌐 Go | 📅 2026-09-04 - Provider for Azure DevOps (VSTS).
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 59 | 🌐 Go | 📅 2026-09-07 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-panos](https://github.com/PaloAltoNetworks/terraform-provider-panos) ⭐ 114 | 🐛 153 | 🌐 Go | 📅 2026-08-03 - Provider for [Palo Alto Networks next-generation firewalls](https://www.paloaltonetworks.com/network-security).
* [terraform-provider-heroku](https://github.com/heroku/terraform-provider-heroku) ⭐ 102 | 🐛 38 | 🌐 Go | 📅 2026-09-06 - Provider for Heroku.
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 73 | 🐛 24 | 🌐 Go | 📅 2026-09-07 - Provider to manage UCloud resources.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 132 | 🌐 Go | 📅 2026-09-05 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 21 | 🌐 Go | 📅 2026-09-07 - Provider for Buildkite.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-devhelm](https://github.com/devhelmhq/terraform-provider-devhelm) ⭐ 0 | 🐛 56 | 🌐 Go | 📅 2026-08-25 - Provider for [DevHelm](https://devhelm.io) uptime monitoring — manage monitors, alert channels, and status pages as code.
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,952 | 🐛 128 | 🌐 Go | 📅 2026-09-02 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 818 | 🐛 37 | 🌐 Go | 📅 2026-09-05 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 342 | 🐛 3 | 🌐 Go | 📅 2026-09-07 - Terraform provider for managing MinIO S3 buckets and IAM Users.
...
* [terraform-provider-seerr](https://github.com/Josh-Archer/terraform-provider-seerr) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2026-09-04 - Terraform provider for Seerr (Overseerr/Jellyseerr).
* [terraform-provider-plancost](https://github.com/plancost/terraform-provider-plancost) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-03-11 - Terraform provider for Azure cost estimation and cost guardrails.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,943 | 🐛 9 | 🌐 Go | 📅 2026-09-07 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,634 | 🐛 1,924 | 🌐 Go | 📅 2026-09-07 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,509 | 🐛 20 | 🌐 Go | 📅 2026-09-02 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,819 | 🐛 229 | 🌐 Go | 📅 2026-09-07 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,281 | 🐛 918 | 🌐 Go | 📅 2026-09-07 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,987 | 🐛 162 | 🌐 Python | 📅 2026-09-05 - Terraform static analysis tool for terraform>=0.12
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,767 | 🐛 26 | 🌐 Shell | 📅 2026-09-05 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,623 | 🐛 102 | 🌐 Go | 📅 2026-09-07 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,325 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,698 | 🐛 317 | 🌐 Open Policy Agent | 📅 2026-09-07 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,389 | 🐛 95 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,372 | 🐛 286 | 🌐 Go | 📅 2026-09-07 - A universal tool that converts deep merged YAML to module inputs.
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 398 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-07 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 371 | 🐛 4 | 🌐 Rust | 📅 2026-09-03 - A CLI tool that helps you interact with Terraform via the Model Context Protocol (MCP), allowing AI assistants like Claude to manage and operate Terraform environments.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,567 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 197 | 🐛 22 | 🌐 Go | 📅 2026-09-07 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-07 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 3 | 🌐 Shell | 📅 2026-09-07.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-07 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [python-hcl2](https://github.com/amplify-education/python-hcl2/) ⭐ 317 | 🐛 41 | 🌐 Python | 📅 2026-09-07 - HCL2 parser in Python
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,439 | 🐛 1,433 | 🌐 Rust | 📅 2026-09-06
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 753 | 🐛 71 | 🌐 Go | 📅 2026-09-07 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
...
* [Snap CD](https://github.com/schrieksoft/snapcd) ⭐ 3 | 🐛 1 | 🌐 C# | 📅 2026-09-05 - Fully-featured continuous deployment platform that facilitates modular deployments with isolated runners, dependency-aware automation, and fine-grained access control.
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,202 | 🐛 266 | 🌐 Go | 📅 2026-09-07 (Terraform Language Server)
