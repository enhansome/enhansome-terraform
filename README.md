...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,592 | 🐛 6 | 📅 2026-09-09
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,592 | 🐛 6 | 📅 2026-09-09
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,592 | 🐛 6 | 📅 2026-09-09 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,660 | 🐛 1,924 | 🌐 Go | 📅 2026-09-15
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,343 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [awesome-terraform-compliance](https://github.com/antonbabenko/awesome-terraform-compliance) ⭐ 144 | 🐛 1 | 📅 2026-07-29 - Curated list of tools, frameworks, and resources for Terraform compliance and security.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,534 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [azure-az104](https://github.com/victorlane/azure-az104) ⭐ 1 | 🐛 0 | 🌐 HCL | 📅 2026-08-23 - AZ-104 Azure Administrator study notes and hands-on Terraform examples, including a landing-zone reference architecture.
...
* [Self-host n8n on Google Cloud Run](https://github.com/datawranglerai/self-host-n8n-on-gcr) ⭐ 617 | 🐛 0 | 🌐 HCL | 📅 2026-05-13 - Terraform configuration and guide for deploying n8n workflow automation on Cloud Run with Cloud SQL, Secret Manager, and optional Queue Mode via Redis.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,004 | 🐛 14 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
* [terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) ⭐ 3,262 | 🐛 18 | 🌐 HCL | 📅 2026-08-28 - Creates VPC resources on AWS (verified and very popular module).
...
* [typhoon](https://github.com/poseidon/typhoon) ⭐ 2,051 | 🐛 7 | 🌐 HCL | 📅 2026-09-15 - Minimal and free Kubernetes distribution with Terraform.
* [terraform-aws-secure-baseline](https://github.com/nozaq/terraform-aws-secure-baseline) ⭐ 1,201 | 🐛 28 | 🌐 HCL | 📅 2026-09-13 - Set up your AWS account with the secure baseline configuration based on CIS Amazon Web Services Foundations.
* [terraform-aws-lambda](https://github.com/terraform-aws-modules/terraform-aws-lambda) ⭐ 1,043 | 🐛 10 | 🌐 HCL | 📅 2026-08-06 - Terraform module, which builds dependencies and packages, and also creates AWS Lambda resources in countless combinations.
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 963 | 🐛 18 | 🌐 HCL | 📅 2026-09-08 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
...
* [terraform-aws-security-group](https://github.com/terraform-aws-modules/terraform-aws-security-group) ⭐ 594 | 🐛 3 | 🌐 HCL | 📅 2026-08-06 - Creates EC2-VPC security groups on AWS (verified module).
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 585 | 🐛 7 | 🌐 HCL | 📅 2026-09-15 - Creates S3 bucket resources on AWS.
...
* [terraform-aws-alb](https://github.com/terraform-aws-modules/terraform-aws-alb) ⭐ 466 | 🐛 1 | 🌐 HCL | 📅 2026-08-26 - Creates Application load-balancer on AWS (verified module).
* [terraform-aws-rds-aurora](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora) ⭐ 420 | 🐛 1 | 🌐 HCL | 📅 2026-09-06 - Creates RDS Aurora cluster resources on AWS (verified module).
* [terraform-nixos](https://github.com/nix-community/terraform-nixos) ⭐ 418 | 🐛 33 | 🌐 HCL | 📅 2024-08-04 - A set of Terraform modules that are designed to deploy NixOS.
* [terraform-aws-autoscaling](https://github.com/terraform-aws-modules/terraform-aws-autoscaling) ⭐ 311 | 🐛 1 | 🌐 HCL | 📅 2026-08-26 - Creates Auto-Scaling Groups and Launch Configurations (verified module).
...
* [terraform-aws-transit-gateway](https://github.com/terraform-aws-modules/terraform-aws-transit-gateway) ⭐ 163 | 🐛 0 | 🌐 HCL | 📅 2026-08-06 - Creates Transit Gateway resources on AWS.
...
* [terraform-aws-dms](https://github.com/terraform-aws-modules/terraform-aws-dms) ⭐ 73 | 🐛 1 | 🌐 HCL | 📅 2026-08-26 - Creates AWS DMS (Database Migration Service) resources on AWS.
...
* [terraform-helm-carbon-intensity-exporter](https://github.com/fabiocicerchia/terraform-helm-carbon-intensity-exporter) ⭐ 0 | 🐛 0 | 🌐 HCL | 📅 2026-09-08 - Terraform/Helm module to deploy the Kubernetes Carbon Intensity Exporter.
* [terraform-helm-kepler](https://github.com/fabiocicerchia/terraform-helm-kepler) ⭐ 0 | 🐛 0 | 🌐 HCL | 📅 2026-09-12 - Terraform module to deploy Kepler (Kubernetes power profiling) via Helm.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 520 | 🐛 21 | 🌐 Go | 📅 2026-09-12 - Terraform Private Registry for modules and providers manageable from a REST API.
* [Terrareg](https://github.com/matthewjohn/terrareg) ⭐ 347 | 🐛 20 | 🌐 Go | 📅 2026-05-11 - Terraform module registry.
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 293 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
* [tapir](https://github.com/PacoVK/tapir) ⭐ 239 | 🐛 36 | 🌐 Java | 📅 2026-09-10 - Private Terraform Registry.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,091 | 🐛 3,587 | 🌐 Go | 📅 2026-09-15 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,971 | 🐛 3,064 | 🌐 Go | 📅 2026-09-15 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,644 | 🐛 2,718 | 🌐 Go | 📅 2026-09-15 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,719 | 🐛 218 | 🌐 Go | 📅 2026-09-15 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,076 | 🐛 196 | 🌐 Go | 📅 2026-09-02 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 118 | 🌐 Go | 📅 2026-09-14 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,181 | 🐛 337 | 🌐 Go | 📅 2026-09-15 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 947 | 🐛 342 | 🌐 Go | 📅 2026-09-15 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 739 | 🐛 56 | 🌐 Go | 📅 2026-09-14 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 698 | 🐛 216 | 🌐 Go | 📅 2026-09-14 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 839 | 🌐 Go | 📅 2026-09-15 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 568 | 🐛 196 | 🌐 Go | 📅 2026-09-09 - Provider for DigitalOcean.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 468 | 🐛 413 | 🌐 Go | 📅 2026-09-15 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 436 | 🐛 111 | 📅 2026-08-20 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 430 | 🐛 212 | 🌐 Go | 📅 2026-09-09 - Provider for Azure DevOps (VSTS).
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 806 | 🌐 Go | 📅 2026-09-15 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 294 | 🐛 181 | 🌐 Go | 📅 2026-09-11 - Provider for Rancher v2.
* [terraform-provider-artifactory](https://github.com/jfrog/terraform-provider-artifactory) ⭐ 289 | 🐛 91 | 🌐 Go | 📅 2026-09-11 - Provider for [JFrog Artifactory](https://jfrog.com/artifactory/).
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 68 | 🌐 Go | 📅 2026-09-09 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 68 | 🌐 Go | 📅 2026-09-15 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-panos](https://github.com/PaloAltoNetworks/terraform-provider-panos) ⭐ 114 | 🐛 154 | 🌐 Go | 📅 2026-08-03 - Provider for [Palo Alto Networks next-generation firewalls](https://www.paloaltonetworks.com/network-security).
* [terraform-provider-heroku](https://github.com/heroku/terraform-provider-heroku) ⭐ 102 | 🐛 35 | 🌐 Go | 📅 2026-09-14 - Provider for Heroku.
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 74 | 🐛 23 | 🌐 Go | 📅 2026-09-15 - Provider to manage UCloud resources.
...
* [terraform-provider-coder](https://github.com/coder/terraform-provider-coder) ⭐ 60 | 🐛 51 | 🌐 Go | 📅 2026-09-09 - Provider for [Coder](https://coder.com)
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 141 | 🌐 Go | 📅 2026-09-15 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 18 | 🌐 Go | 📅 2026-09-14 - Provider for Buildkite.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 9 | 🌐 Go | 📅 2026-09-15 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 39 | 🐛 13 | 🌐 Go | 📅 2026-09-15 - Provider for [env0](https://www.env0.com/)
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 30 | 🐛 10 | 🌐 Go | 📅 2026-09-15 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-scalr](https://github.com/Scalr/terraform-provider-scalr) ⭐ 19 | 🐛 5 | 🌐 Go | 📅 2026-09-10 - Provider for [Scalr](https://www.scalr.com/)
* [terraform-provider-qovery](https://github.com/Qovery/terraform-provider-qovery) ⭐ 18 | 🐛 10 | 🌐 Go | 📅 2026-09-03 - Provider for [Qovery](https://www.qovery.com/) — manage Kubernetes deployments, environments, applications, databases, Helm charts, and Terraform services on AWS, GCP, Azure, and Scaleway.
* [terraform-provider-phare](https://github.com/phare/terraform-provider-phare) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-09-13 -  Terraform provider for [Phare](https://phare.io).
* [terraform-provider-devhelm](https://github.com/devhelmhq/terraform-provider-devhelm) ⭐ 0 | 🐛 62 | 🌐 Go | 📅 2026-08-25 - Provider for [DevHelm](https://devhelm.io) uptime monitoring — manage monitors, alert channels, and status pages as code.
* [terraform-provider-nxip](https://github.com/uk-sw/terraform-provider-nxip) ⭐ 0 | 🐛 4 | 🌐 Go | 📅 2026-09-05 - Provider for [nxip](https://nx-ip.com), IPAM with pool-based CIDR allocation across cloud and on-premise. :heavy\_dollar\_sign:

### Community providers

* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,953 | 🐛 129 | 🌐 Go | 📅 2026-09-14 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 819 | 🐛 37 | 🌐 Go | 📅 2026-09-11 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 342 | 🐛 2 | 🌐 Go | 📅 2026-09-15 - Terraform provider for managing MinIO S3 buckets and IAM Users.
* [terraform-provider-terracurl](https://github.com/devops-rob/terraform-provider-terracurl) ⭐ 164 | 🐛 13 | 🌐 Go | 📅 2026-09-14 - Provider to make managed and unmanaged API calls to your target endpoint.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 24 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - Terraform provider for Coolify.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 24 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - Terraform provider for Coolify.
...
* [terraform-provider-seerr](https://github.com/Josh-Archer/terraform-provider-seerr) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-09-15 - Terraform provider for Seerr (Overseerr/Jellyseerr).
* [terraform-provider-plancost](https://github.com/plancost/terraform-provider-plancost) ⭐ 5 | 🐛 6 | 🌐 Go | 📅 2026-03-11 - Terraform provider for Azure cost estimation and cost guardrails.
...
* [terraform-provider-paddle](https://github.com/vivantel/terraform-provider-paddle) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-09-14 - Terraform provider for Paddle Billing catalog resources, lifecycle actions, and lookup data sources.
* [terraform-provider-seekrit](https://github.com/seekritdev/terraform-provider-seekrit) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - Manage seekrit apps, environments, groups, service tokens, key grants and secrets. Write-only arguments and ephemeral resources keep secret values out of state.

## Testing

* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,943 | 🐛 8 | 🌐 Go | 📅 2026-09-15 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,660 | 🐛 1,924 | 🌐 Go | 📅 2026-09-15 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,516 | 🐛 22 | 🌐 Go | 📅 2026-09-09 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,832 | 🐛 249 | 🌐 Go | 📅 2026-09-15 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,288 | 🐛 938 | 🌐 Go | 📅 2026-09-13 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 9,001 | 🐛 169 | 🌐 Python | 📅 2026-09-10 - Terraform static analysis tool for terraform>=0.12
* [tfsec](https://github.com/aquasecurity/tfsec) ⭐ 7,036 | 🐛 18 | 🌐 Go | 📅 2026-03-25 - Terraform static analysis tool that supports terraform <0.12 & >=0.12 & directly integrates with HCL parser for better results.
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,815 | 🐛 32 | 🌐 Go | 📅 2026-09-12 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,969 | 🐛 34 | 🌐 Shell | 📅 2026-07-01 - Terraform version manager inspired by rbenv.
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,823 | 🐛 194 | 🌐 Go | 📅 2026-09-02 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,773 | 🐛 27 | 🌐 Shell | 📅 2026-09-15 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,628 | 🐛 103 | 🌐 Go | 📅 2026-09-08 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,326 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,700 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-15 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,391 | 🐛 95 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [inframap](https://github.com/cycloidio/inframap) ⭐ 2,066 | 🐛 50 | 🌐 Go | 📅 2026-04-23 - Read your tfstate or HCL to generate a graph specific for each provider, showing only the resources that are most important/relevant.
* [terraboard](https://github.com/camptocamp/terraboard) ⭐ 2,008 | 🐛 27 | 🌐 Go | 📅 2026-06-15 - Web dashboard to inspect Terraform States.
* [Kapitan](https://github.com/kapicorp/kapitan) ⭐ 1,924 | 🐛 155 | 🌐 Python | 📅 2026-09-09 - Generates Terraform/OpenTofu JSON and other infrastructure configuration from inventory-driven templates.
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,911 | 🐛 24 | 🌐 Go | 📅 2026-09-15 - A tool to bring existing Azure resources under Terraform's management.
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,632 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,435 | 🐛 46 | 🌐 Go | 📅 2026-09-01 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,401 | 🐛 20 | 🌐 Go | 📅 2026-09-11 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,378 | 🐛 293 | 🌐 Go | 📅 2026-09-15 - A universal tool that converts deep merged YAML to module inputs.
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - A textual user interface for Terraform state.
...
* [terratag](https://github.com/env0/terratag) ⭐ 1,056 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - Terratag is a CLI tool that enables users of Terraform to automatically create and maintain tags across their entire set of AWS, Azure, and GCP resources.
* [yj](https://github.com/sclevine/yj) ⭐ 1,053 | 🐛 26 | 🌐 Go | 📅 2026-05-15 - CLI - Convert between YAML, TOML, JSON, and HCL. Preserves map order.
...
* [yor](https://github.com/bridgecrewio/yor) ⭐ 931 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - Automatically tag and trace infrastructure as code frameworks (Terraform, Cloudformation, and Serverless).
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 929 | 🐛 5 | 🌐 HCL | 📅 2026-09-14 - Pike calculates the permissions or IAM policy required to build your Terraform.
* [tfautomv](https://github.com/busser/tfautomv) ⭐ 899 | 🐛 18 | 🌐 Go | 📅 2026-09-02 - Generate Terraform `moved` blocks automatically for painless refactoring
...
* [AirIAM](https://github.com/bridgecrewio/AirIAM) ⭐ 827 | 🐛 34 | 🌐 Python | 📅 2025-03-18 - AirIAM is a tool for AWS IAM to least privilege Terraform execution framework.
* [iam-policy-json-to-terraform](https://github.com/flosell/iam-policy-json-to-terraform) ⭐ 816 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-10 - Small tool to convert an IAM Policy in JSON format into a Terraform aws\_iam\_policy\_document
...
* [aws2tf](https://github.com/aws-samples/aws2tf) ⭐ 764 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - automates the importing of existing AWS resources into Terraform and outputs the Terraform HCL code.
* [terragrunt-atlantis-config](https://github.com/transcend-io/terragrunt-atlantis-config) ⭐ 743 | 🐛 93 | 🌐 HCL | 📅 2025-11-20 - Generate Atlantis config for Terragrunt projects.
* [tf-summarize](https://github.com/dineshba/tf-summarize) ⭐ 735 | 🐛 31 | 🌐 Go | 📅 2026-03-20 - A command-line utility to print the summary of the terraform plan
* [pug](https://github.com/leg100/pug) ⭐ 700 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - The terminal user interface for terraform power users.
* [Terraform-Visual](https://github.com/hieven/terraform-visual) ⭐ 673 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-11 - A simple but powerful tool to visualize Terraform plan.
...
* [hcledit (minamijoyo)](https://github.com/minamijoyo/hcledit) ⭐ 555 | 🐛 20 | 🌐 Go | 📅 2026-05-05 - A command line editor for HCL.
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 548 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 464 | 🐛 17 | 🌐 Go | 📅 2026-09-13 - Documenting your Threat Models with HCL
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 401 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-15 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 370 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 - A CLI tool that helps you interact with Terraform via the Model Context Protocol (MCP), allowing AI assistants like Claude to manage and operate Terraform environments.
...
* [terracost](https://github.com/cycloidio/terracost) ⭐ 356 | 🐛 21 | 🌐 Go | 📅 2026-05-07 - Cloud cost estimation for Terraform in your CLI.
* [pipeform](https://github.com/magodo/pipeform) ⭐ 355 | 🐛 1 | 🌐 Go | 📅 2026-05-12 - Terraform runtime TUI
* [terraform-iam-policy-validator](https://github.com/awslabs/terraform-iam-policy-validator) ⭐ 355 | 🐛 17 | 🌐 Python | 📅 2025-06-09 - CLI validates AWS IAM Policies in a Terraform template against AWS IAM best practices.
...
* [tfschema](https://github.com/minamijoyo/tfschema) ⭐ 315 | 🐛 4 | 🌐 Go | 📅 2026-05-04 - Schema inspector for Terraform providers.
* [fogg](https://github.com/chanzuckerberg/fogg) ⭐ 306 | 🐛 2 | 🌐 Go | 📅 2026-09-14 - A tool for eliminating toil in managing terraform repositories.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,588 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 201 | 🐛 21 | 🌐 Go | 📅 2026-09-15 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
* [redc](https://github.com/wgpsec/redc) ⭐ 194 | 🐛 1 | 🌐 Go | 📅 2026-08-10 - Next-generation red team infrastructure automation tool built on Terraform, supporting multi-cloud deployment (Alibaba Cloud, Tencent Cloud, AWS, etc.) with one-command deployment for creating, configuring, and destroying red team environments.
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-09-14 - Rename Terraform resources and generate moved blocks
...
* [ruby-terraform](https://github.com/infrablocks/ruby_terraform) ⭐ 112 | 🐛 4 | 🌐 Ruby | 📅 2026-09-14 - Simple Ruby wrapper for invoking terraform commands.
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2026-09-15 - CLI to prevent malicious Terraform Providers from being executed
...
* [cloud-audit](https://github.com/gebalamariusz/cloud-audit) ⭐ 72 | 🐛 8 | 🌐 Python | 📅 2026-09-15 - AWS security auditing CLI with remediation engine that generates Terraform code for fixing misconfigurations.
...
* [renovate-config](https://github.com/SpotOnInc/renovate-config) ⭐ 55 | 🐛 3 | 📅 2026-09-15 - Sharable Config Presets for Renovatebot, especially useful for DevOps folks.
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 42 | 🐛 5 | 🌐 Shell | 📅 2026-09-14 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [tf-why](https://github.com/Raj-glitch-max/tf.why) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-05-04 - CLI tool that attributes Terraform drift to the AWS actor who caused it, via CloudTrail lookup.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 20 | 🐛 2 | 🌐 Go | 📅 2026-09-11 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
...
* [SyncVey](https://github.com/MR-TABATA/SyncVey) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Self-hosted AWS asset ledger with attribute-level drift detection between tfstate and live AWS state, scheduled scans, and middleware EOL alerts.
...
* [setup-terraform](https://github.com/hashicorp/setup-terraform) ⭐ 1,586 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-07 - Sets up Terraform CLI in your GitHub Actions workflow.
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-15 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [opentofu-updater-action](https://github.com/drumandbytes/opentofu-updater-action) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - GitHub Action that keeps OpenTofu/Terraform providers, modules, Helm charts and container images up to date by opening pull requests.
...
* [python-hcl2](https://github.com/amplify-education/python-hcl2/) ⭐ 317 | 🐛 41 | 🌐 Python | 📅 2026-09-08 - HCL2 parser in Python
* [hcl-rs](https://github.com/martinohmann/hcl-rs) ⭐ 185 | 🐛 11 | 🌐 Rust | 📅 2026-09-05 - HCL parsing and encoding libraries for rust with serde support
* [tree-sitter-hcl](https://github.com/tree-sitter-grammars/tree-sitter-hcl) ⭐ 146 | 🐛 8 | 🌐 HCL | 📅 2026-09-13 - HCL grammar for tree-sitter
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,513 | 🐛 1,440 | 🌐 Rust | 📅 2026-09-14
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 751 | 🐛 65 | 🌐 Go | 📅 2026-09-15 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
* [OTF](https://github.com/leg100/otf) ⭐ 702 | 🐛 29 | 🌐 Go | 📅 2026-07-16 - Open Terraforming Framework, an open source alternative to Terraform Enterprise with full Terraform CLI integration.
* [Lynx](https://github.com/clivern/lynx) ⭐ 365 | 🐛 19 | 🌐 Elixir | 📅 2026-09-11 - Fast, Secure and Reliable Terraform Backend. It has a user-friendly dashboard, project and environment management, state versioning, locking and snapshots support.
...
* [Snap CD](https://github.com/schrieksoft/snapcd) ⭐ 9 | 🐛 1 | 🌐 C# | 📅 2026-09-12 - Fully-featured continuous deployment platform that facilitates modular deployments with isolated runners, dependency-aware automation, and fine-grained access control.
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,202 | 🐛 264 | 🌐 Go | 📅 2026-09-15 (Terraform Language Server)
* [Vim-Terraform](https://github.com/hashivim/vim-terraform) ⭐ 1,107 | 🐛 5 | 🌐 Vim Script | 📅 2025-05-24
...
* [Emacs terraform-mode](https://github.com/hcl-emacs/terraform-mode) ⭐ 243 | 🐛 9 | 🌐 Emacs Lisp | 📅 2025-11-15
