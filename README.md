...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,590 | 🐛 11 | 📅 2026-09-05
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,590 | 🐛 11 | 📅 2026-09-05
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,590 | 🐛 11 | 📅 2026-09-05 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,621 | 🐛 1,919 | 🌐 Go | 📅 2026-09-04
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,074 | 🐛 3,580 | 🌐 Go | 📅 2026-09-04 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,969 | 🐛 3,046 | 🌐 Go | 📅 2026-09-06 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,643 | 🐛 2,686 | 🌐 Go | 📅 2026-09-06 - Provider for Google Cloud Platform.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,165 | 🐛 342 | 🌐 Go | 📅 2026-09-05 - Provider for GitHub.
...
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 749 | 🌐 Go | 📅 2026-09-05 - Provider for Alibaba Cloud.
...
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 75 | 🌐 Go | 📅 2026-09-06 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 11 | 🌐 Go | 📅 2026-09-04 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 29 | 🐛 8 | 🌐 Go | 📅 2026-09-02 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-devhelm](https://github.com/devhelmhq/terraform-provider-devhelm) ⭐ 0 | 🐛 51 | 🌐 Go | 📅 2026-08-25 - Provider for [DevHelm](https://devhelm.io) uptime monitoring — manage monitors, alert channels, and status pages as code.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,943 | 🐛 9 | 🌐 Go | 📅 2026-09-05 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
* [terraform-compliance](https://github.com/terraform-compliance/cli) ⭐ 1,462 | 🐛 99 | 🌐 Python | 📅 2026-05-08 - BDD Testing for Terraform Files.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,621 | 🐛 1,919 | 🌐 Go | 📅 2026-09-04 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,508 | 🐛 20 | 🌐 Go | 📅 2026-09-02 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,818 | 🐛 231 | 🌐 Go | 📅 2026-09-04 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,282 | 🐛 911 | 🌐 Go | 📅 2026-09-06 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,984 | 🐛 162 | 🌐 Python | 📅 2026-09-05 - Terraform static analysis tool for terraform>=0.12
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,802 | 🐛 33 | 🌐 Go | 📅 2026-09-05 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,372 | 🐛 290 | 🌐 Go | 📅 2026-09-06 - A universal tool that converts deep merged YAML to module inputs.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 548 | 🐛 29 | 🌐 Go | 📅 2026-09-06 - CLI to notify the result of plan and apply as Pull Request comment.
...
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 463 | 🐛 21 | 🌐 Go | 📅 2026-09-06 - Documenting your Threat Models with HCL
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 398 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-06 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,565 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-06.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-06 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,423 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-05
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 753 | 🐛 70 | 🌐 Go | 📅 2026-09-06 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
