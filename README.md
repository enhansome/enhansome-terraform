...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,610 | 🐛 1,916 | 🌐 Go | 📅 2026-09-03
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,324 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,532 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 962 | 🐛 20 | 🌐 HCL | 📅 2026-09-03 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
...
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 291 | 🐛 28 | 🌐 Go | 📅 2026-09-03 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
* [tapir](https://github.com/PacoVK/tapir) ⭐ 239 | 🐛 33 | 🌐 Java | 📅 2026-09-02 - Private Terraform Registry.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,050 | 🐛 3,586 | 🌐 Go | 📅 2026-09-03 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,970 | 🐛 3,028 | 🌐 Go | 📅 2026-09-03 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,643 | 🐛 2,683 | 🌐 Go | 📅 2026-09-03 - Provider for Google Cloud Platform.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,164 | 🐛 343 | 🌐 Go | 📅 2026-09-03 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 947 | 🐛 346 | 🌐 Go | 📅 2026-09-03 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 738 | 🐛 55 | 🌐 Go | 📅 2026-09-03 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 696 | 🐛 220 | 🌐 Go | 📅 2026-09-03 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 732 | 🌐 Go | 📅 2026-09-03 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 467 | 🐛 409 | 🌐 Go | 📅 2026-09-03 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 436 | 🐛 111 | 📅 2026-08-20 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 430 | 🐛 224 | 🌐 Go | 📅 2026-09-02 - Provider for Azure DevOps (VSTS).
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 808 | 🌐 Go | 📅 2026-09-03 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 293 | 🐛 184 | 🌐 Go | 📅 2026-08-26 - Provider for Rancher v2.
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 67 | 🌐 Go | 📅 2026-09-03 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 69 | 🌐 Go | 📅 2026-09-03 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 132 | 🌐 Go | 📅 2026-09-03 - Provider for Confluent.
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 18 | 🌐 Go | 📅 2026-09-03 - Provider for Buildkite.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 44 | 🐛 9 | 🌐 Go | 📅 2026-09-03 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,951 | 🐛 126 | 🌐 Go | 📅 2026-09-02 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 819 | 🐛 36 | 🌐 Go | 📅 2026-09-03 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 342 | 🐛 1 | 🌐 Go | 📅 2026-09-03 - Terraform provider for managing MinIO S3 buckets and IAM Users.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 21 | 🐛 6 | 📅 2026-09-02 - Terraform provider for Coolify.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,610 | 🐛 1,916 | 🌐 Go | 📅 2026-09-03 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,505 | 🐛 19 | 🌐 Go | 📅 2026-09-02 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,816 | 🐛 227 | 🌐 Go | 📅 2026-09-03 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,279 | 🐛 910 | 🌐 Go | 📅 2026-09-03 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,977 | 🐛 168 | 🌐 Python | 📅 2026-09-01 - Terraform static analysis tool for terraform>=0.12
...
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,816 | 🐛 192 | 🌐 Go | 📅 2026-09-02 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,766 | 🐛 26 | 🌐 Shell | 📅 2026-09-01 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
...
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-09-03 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,369 | 🐛 294 | 🌐 Go | 📅 2026-09-03 - A universal tool that converts deep merged YAML to module inputs.
...
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 463 | 🐛 17 | 🌐 Go | 📅 2026-09-03 - Documenting your Threat Models with HCL
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,562 | 🐛 149 | 🌐 Go | 📅 2026-09-03 version manager
...
* [terrascope](https://github.com/spilliams/terrascope) ⭐ 26 | 🐛 44 | 🌐 Go | 📅 2026-09-03 - Build orchestrator for terraform monorepos.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 12 | 🐛 0 | 🌐 Go | 📅 2026-08-26 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
* [hq](https://github.com/miller-time/hq) ⭐ 9 | 🐛 2 | 🌐 Rust | 📅 2025-03-23 - command-line HCL processor
* [tfvault](https://github.com/tedilabs/tfvault) ⭐ 9 | 🐛 4 | 🌐 Go | 📅 2026-08-12 - Universal Terraform credentials helper with pluggable secret backends (OS keyring, pass/gopass, environment variables) and per-profile account isolation.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 2 | 🌐 Shell | 📅 2026-09-03 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-03.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-03 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [hcl-rs](https://github.com/martinohmann/hcl-rs) ⭐ 184 | 🐛 10 | 🌐 Rust | 📅 2026-09-03 - HCL parsing and encoding libraries for rust with serde support
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,410 | 🐛 1,422 | 🌐 Rust | 📅 2026-09-03
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 752 | 🐛 71 | 🌐 Go | 📅 2026-09-03 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
