...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,568 | 🐛 12 | 📅 2026-07-27
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,568 | 🐛 12 | 📅 2026-07-27
[![Not Found Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml) ⭐ 6,568 | 🐛 12 | 📅 2026-07-27
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,568 | 🐛 12 | 📅 2026-07-27 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,465 | 🐛 1,924 | 🌐 Go | 📅 2026-08-14
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,274 | 🐛 2 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 4,995 | 🐛 15 | 🌐 HCL | 📅 2026-08-14 - Creates Elastic Kubernetes Service on AWS (very popular module).
...
* [terralist](https://github.com/terralist/terralist) ⭐ 512 | 🐛 22 | 🌐 Go | 📅 2026-08-14 - Terraform Private Registry for modules and providers manageable from a REST API.
* [Terrareg](https://github.com/matthewjohn/terrareg) ⭐ 347 | 🐛 20 | 🌐 Go | 📅 2026-05-11 - Terraform module registry.
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 290 | 🐛 27 | 🌐 Go | 📅 2026-08-14 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
* [tapir](https://github.com/PacoVK/tapir) ⭐ 238 | 🐛 33 | 🌐 Java | 📅 2026-08-14 - Private Terraform Registry.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,048 | 🐛 3,552 | 🌐 Go | 📅 2026-08-14 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,969 | 🐛 3,941 | 🌐 Go | 📅 2026-08-15 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,640 | 🐛 2,450 | 🌐 Go | 📅 2026-08-15 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,720 | 🐛 205 | 🌐 Go | 📅 2026-08-12 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,076 | 🐛 191 | 🌐 Go | 📅 2026-07-10 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/vmware/terraform-provider-vsphere) ⭐ 672 | 🐛 121 | 🌐 Go | 📅 2026-08-13 - Provider for VMware vSphere.
...
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,157 | 🐛 333 | 🌐 Go | 📅 2026-08-13 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 942 | 🐛 339 | 🌐 Go | 📅 2026-08-11 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 731 | 🐛 59 | 🌐 Go | 📅 2026-08-15 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 691 | 🐛 244 | 🌐 Go | 📅 2026-08-13 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 660 | 🐛 767 | 🌐 Go | 📅 2026-08-14 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 568 | 🐛 187 | 🌐 Go | 📅 2026-08-15 - Provider for DigitalOcean.
* [terraform-provider-openstack](https://github.com/terraform-provider-openstack/terraform-provider-openstack) ⭐ 473 | 🐛 210 | 🌐 Go | 📅 2026-08-10 - Plugin for OpenStack.
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 465 | 🐛 425 | 🌐 Go | 📅 2026-08-14 - Provider for Datadog.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 293 | 🐛 204 | 🌐 Go | 📅 2026-08-14 - Provider for Rancher v2.
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 243 | 🐛 67 | 🌐 Go | 📅 2026-08-14 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 208 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 58 | 🐛 122 | 🌐 Go | 📅 2026-08-15 - Provider for Confluent.
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,937 | 🐛 123 | 🌐 Go | 📅 2026-08-14 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 816 | 🐛 32 | 🌐 Go | 📅 2026-08-13 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 341 | 🐛 1 | 🌐 Go | 📅 2026-08-14 - Terraform provider for managing MinIO S3 buckets and IAM Users.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 15 | 🐛 5 | 🌐 Go | 📅 2026-08-14 - Terraform provider for Coolify.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,942 | 🐛 1 | 🌐 Go | 📅 2026-08-13 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,465 | 🐛 1,924 | 🌐 Go | 📅 2026-08-14 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,450 | 🐛 24 | 🌐 Go | 📅 2026-08-11 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,777 | 🐛 229 | 🌐 Go | 📅 2026-08-14 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,234 | 🐛 889 | 🌐 Go | 📅 2026-08-15 - Unified workflow for collaborating on Terraform through GitHub.
...
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,790 | 🐛 27 | 🌐 Go | 📅 2026-08-15 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,960 | 🐛 31 | 🌐 Shell | 📅 2026-07-01 - Terraform version manager inspired by rbenv.
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,814 | 🐛 188 | 🌐 Go | 📅 2026-08-03 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,756 | 🐛 29 | 🌐 Shell | 📅 2026-08-14 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
...
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,603 | 🐛 5 | 🌐 Python | 📅 2026-08-10 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,428 | 🐛 47 | 🌐 Go | 📅 2026-07-25 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,393 | 🐛 17 | 🌐 Go | 📅 2026-07-28 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,355 | 🐛 303 | 🌐 Go | 📅 2026-08-15 - A universal tool that converts deep merged YAML to module inputs.
...
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 927 | 🐛 6 | 🌐 HCL | 📅 2026-08-14 - Pike calculates the permissions or IAM policy required to build your Terraform.
...
* [tf-summarize](https://github.com/dineshba/tf-summarize) ⭐ 726 | 🐛 31 | 🌐 Go | 📅 2026-03-20 - A command-line utility to print the summary of the terraform plan
* [pug](https://github.com/leg100/pug) ⭐ 692 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - The terminal user interface for terraform power users.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 546 | 🐛 28 | 🌐 Go | 📅 2026-08-15 - CLI to notify the result of plan and apply as Pull Request comment.
* [json2hcl](https://github.com/kvz/json2hcl) ⚠️ Archived - Convert JSON to HCL and vice versa. :ghost:
* [hcl2json](https://github.com/tmccombs/hcl2json) ⭐ 480 | 🐛 10 | 🌐 Go | 📅 2026-07-21 - Convert hcl2 to json.
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 464 | 🐛 17 | 🌐 Go | 📅 2026-08-15 - Documenting your Threat Models with HCL
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 264 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,524 | 🐛 151 | 🌐 Go | 📅 2026-08-12 version manager
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-08-15 - Rename Terraform resources and generate moved blocks
...
* [tgf](https://github.com/coveooss/tgf) ⭐ 108 | 🐛 3 | 🌐 Go | 📅 2026-08-14 - Terragrunt frontend for executing Terragrunt/Terraform through Docker.
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 89 | 🐛 3 | 🌐 Go | 📅 2026-08-15 - CLI to prevent malicious Terraform Providers from being executed
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-15 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-07-18 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,268 | 🐛 1,413 | 🌐 Rust | 📅 2026-08-14
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 750 | 🐛 70 | 🌐 Go | 📅 2026-08-14 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
