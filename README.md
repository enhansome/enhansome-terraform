...
[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,594 | 🐛 3 | 📅 2026-09-21
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,594 | 🐛 3 | 📅 2026-09-21
...
> Your [contributions](https://github.com/shuaibiyy/awesome-tf/blob/master/contributing.md) ⭐ 6,594 | 🐛 3 | 📅 2026-09-21 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 49,700 | 🐛 1,938 | 🌐 Go | 📅 2026-09-21
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 2,371 | 🐛 3 | 📅 2026-07-03 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,538 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 5,005 | 🐛 16 | 🌐 HCL | 📅 2026-09-18 - Creates Elastic Kubernetes Service on AWS (very popular module).
* [terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) ⭐ 3,266 | 🐛 18 | 🌐 HCL | 📅 2026-09-18 - Creates VPC resources on AWS (verified and very popular module).
...
* [terraform-aws-lambda](https://github.com/terraform-aws-modules/terraform-aws-lambda) ⭐ 1,042 | 🐛 10 | 🌐 HCL | 📅 2026-09-18 - Terraform module, which builds dependencies and packages, and also creates AWS Lambda resources in countless combinations.
...
* [terraform-aws-atlantis](https://github.com/terraform-aws-modules/terraform-aws-atlantis) ⭐ 558 | 🐛 2 | 🌐 HCL | 📅 2026-08-26 - Creates Terraform configurations for running [Atlantis](https://runatlantis.io) on AWS Fargate. Github, Gitlab, and BitBucket are supported.
...
* [terraform-helm-cloud-carbon-footprint](https://github.com/fabiocicerchia/terraform-helm-cloud-carbon-footprint) ⭐ 0 | 🐛 0 | 🌐 HCL | 📅 2026-09-18 - Terraform/Helm module to deploy Cloud Carbon Footprint on Kubernetes.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 11,094 | 🐛 3,562 | 🌐 Go | 📅 2026-09-21 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,971 | 🐛 3,061 | 🌐 Go | 📅 2026-09-21 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,646 | 🐛 2,905 | 🌐 Go | 📅 2026-09-21 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,719 | 🐛 218 | 🌐 Go | 📅 2026-09-21 - Provider for Kubernetes.
...
* [terraform-provider-keycloak](https://github.com/keycloak/terraform-provider-keycloak) ⭐ 948 | 🐛 346 | 🌐 Go | 📅 2026-09-21 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 739 | 🐛 58 | 🌐 Go | 📅 2026-09-21 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/snowflakedb/terraform-provider-snowflake) ⭐ 698 | 🐛 218 | 🌐 Go | 📅 2026-09-21 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 662 | 🐛 885 | 🌐 Go | 📅 2026-09-21 - Provider for Alibaba Cloud.
...
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 469 | 🐛 413 | 🌐 Go | 📅 2026-09-21 - Provider for Datadog.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 362 | 🐛 810 | 🌐 Go | 📅 2026-09-17 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 295 | 🐛 183 | 🌐 Go | 📅 2026-09-21 - Provider for Rancher v2.
* [terraform-provider-artifactory](https://github.com/jfrog/terraform-provider-artifactory) ⭐ 289 | 🐛 93 | 🌐 Go | 📅 2026-09-11 - Provider for [JFrog Artifactory](https://jfrog.com/artifactory/).
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 244 | 🐛 69 | 🌐 Go | 📅 2026-09-21 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 209 | 🐛 91 | 🌐 Go | 📅 2026-09-21 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 74 | 🐛 25 | 🌐 Go | 📅 2026-09-15 - Provider to manage UCloud resources.
...
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 56 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - Provider for Buildkite.
...
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 39 | 🐛 13 | 🌐 Go | 📅 2026-09-21 - Provider for [env0](https://www.env0.com/)
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 31 | 🐛 9 | 🌐 Go | 📅 2026-09-21 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-scalr](https://github.com/Scalr/terraform-provider-scalr) ⭐ 19 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Provider for [Scalr](https://www.scalr.com/)
* [terraform-provider-qovery](https://github.com/Qovery/terraform-provider-qovery) ⭐ 18 | 🐛 11 | 🌐 Go | 📅 2026-09-21 - Provider for [Qovery](https://www.qovery.com/) — manage Kubernetes deployments, environments, applications, databases, Helm charts, and Terraform services on AWS, GCP, Azure, and Scaleway.
...
* [terraform-provider-featureflip](https://github.com/canopy-labs/terraform-provider-featureflip) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-09-14 - Provider for [Featureflip](https://featureflip.io/) feature flags: projects, environments, flags, targeting rules, segments and SDK keys.
...
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 342 | 🐛 2 | 🌐 Go | 📅 2026-09-21 - Terraform provider for managing MinIO S3 buckets and IAM Users.
...
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - Terraform provider for Coolify.
* [terraform-provider-coolify](https://github.com/coolify-terraform/terraform-provider-coolify) ⭐ 25 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - Terraform provider for Coolify.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,947 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 49,700 | 🐛 1,938 | 🌐 Go | 📅 2026-09-21 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,528 | 🐛 24 | 🌐 Go | 📅 2026-09-21 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,844 | 🐛 223 | 🌐 Go | 📅 2026-09-21 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,297 | 🐛 928 | 🌐 Go | 📅 2026-09-21 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 9,017 | 🐛 171 | 🌐 Python | 📅 2026-09-17 - Terraform static analysis tool for terraform>=0.12
...
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,971 | 🐛 34 | 🌐 Shell | 📅 2026-07-01 - Terraform version manager inspired by rbenv.
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,826 | 🐛 195 | 🌐 Go | 📅 2026-09-02 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,776 | 🐛 27 | 🌐 Shell | 📅 2026-09-21 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
...
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-21 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
...
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,393 | 🐛 95 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,913 | 🐛 24 | 🌐 Go | 📅 2026-09-21 - A tool to bring existing Azure resources under Terraform's management.
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,635 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,439 | 🐛 47 | 🌐 Go | 📅 2026-09-21 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,404 | 🐛 21 | 🌐 Go | 📅 2026-09-11 - A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,380 | 🐛 288 | 🌐 Go | 📅 2026-09-20 - A universal tool that converts deep merged YAML to module inputs.
...
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 929 | 🐛 5 | 🌐 HCL | 📅 2026-09-21 - Pike calculates the permissions or IAM policy required to build your Terraform.
...
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 548 | 🐛 29 | 🌐 Go | 📅 2026-09-21 - CLI to notify the result of plan and apply as Pull Request comment.
* [json2hcl](https://github.com/kvz/json2hcl) ⚠️ Archived - Convert JSON to HCL and vice versa. :ghost:
* [hcl2json](https://github.com/tmccombs/hcl2json) ⭐ 480 | 🐛 11 | 🌐 Go | 📅 2026-09-21 - Convert hcl2 to json.
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 466 | 🐛 17 | 🌐 Go | 📅 2026-09-20 - Documenting your Threat Models with HCL
...
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 403 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-21 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 265 | 🐛 16 | 🌐 Shell | 📅 2026-06-19 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,598 | 🐛 147 | 🌐 Go | 📅 2026-09-03 version manager
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 202 | 🐛 20 | 🌐 Go | 📅 2026-09-21 - Open-source security agent framework for reviewing Terraform configurations and investigating live infrastructure through read-only cloud APIs.
...
* [platform-skills](https://github.com/nitinjain999/platform-skills) ⭐ 42 | 🐛 10 | 🌐 Shell | 📅 2026-09-20 - AI-assisted field handbook for Terraform: IAM least privilege review, blast radius analysis, state impact, provider constraints, and rollback planning. Works as a Claude, Codex, Cursor, and Copilot plugin.
...
* [demonolith](https://github.com/schrieksoft/demonolith) ⭐ 21 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Splits up monolithic Terraform projects with `demonolith refactor` (to move the code) and `demonolith migrate` (to migrate into smaller .tfstate files).
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/terraform) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/terraform) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-09-21.
...
* [SyncVey](https://github.com/MR-TABATA/SyncVey) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Self-hosted AWS asset ledger with attribute-level drift detection between tfstate and live AWS state, scheduled scans, and middleware EOL alerts.
...
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-21 - GitHub Action to run Terraform plan and add a comment with the changes.
...
* [opentofu-updater-action](https://github.com/drumandbytes/opentofu-updater-action) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - GitHub Action that keeps OpenTofu/Terraform providers, modules, Helm charts and container images up to date by opening pull requests.
...
* [python-hcl2](https://github.com/amplify-education/python-hcl2/) ⭐ 317 | 🐛 41 | 🌐 Python | 📅 2026-09-21 - HCL2 parser in Python
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 40,543 | 🐛 1,435 | 🌐 Rust | 📅 2026-09-21
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 754 | 🐛 62 | 🌐 Go | 📅 2026-09-21 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
...
* [Snap CD](https://github.com/schrieksoft/snapcd) ⭐ 9 | 🐛 1 | 🌐 C# | 📅 2026-09-21 - Fully-featured continuous deployment platform that facilitates modular deployments with isolated runners, dependency-aware automation, and fine-grained access control.
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,204 | 🐛 265 | 🌐 Go | 📅 2026-09-18 (Terraform Language Server)
